            ...
            <div id="PolenVendorTabs" class="PolenVendorTabs">
                <ul>
                    ...
                    <?php if( is_admin() && ( $current_screen->base == 'user-edit' || ( $current_screen->base == 'user' && $current_screen->action == 'add' ) ) ) { ?>
                        ...
                        <li><a href="#PolenVendorProfileTab7">Configurações Financeiras Para SPLIT</a></li>
                    <?php } ?>
                </ul>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text"
                                           ...
                                           value="<?php echo ( isset( $vendorInfo->stripe_account_id ) ) ? $vendorInfo->stripe_account_id : ''; ?>"
                                           autocomplete="off" class="widefat"
                                    >
                                </td>
                            </tr>
                            <tr>
                                <th>
                                    Porcentagem  para o talento
                                </th>
                                <td>
                                    <input type="text" name="stripe_mdr"
                                           value="<?php echo ( isset( $vendorInfo->stripe_mdr ) ) ? $vendorInfo->stripe_mdr : ''; ?>"
                                           autocomplete="off" class="widefat"
                                    >
                                </td>
                            </tr>
