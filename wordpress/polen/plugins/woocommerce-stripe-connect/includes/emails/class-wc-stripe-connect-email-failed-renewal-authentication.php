 ...
 */
class WC_Stripe_Connect_Email_Failed_Renewal_Authentication extends WC_Stripe_Connect_Email_Failed_Authentication {
	/**
	 * Constructor.
	 *
	...
	public function __construct( $email_classes = array() ) {
		...
		$this->template_base  = ZCWC_STRIPE_CONNECT_PATH . '/templates/';

		// Triggers the email at the correct hook.
		add_action( 'wc_gateway_stripe_connect_process_payment_authentication_required', array( $this, 'trigger' ) );
