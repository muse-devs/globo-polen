 ...
 * @extends WC_Email
 */
abstract class WC_Stripe_Connect_Email_Failed_Authentication extends WC_Email {
	/**
	...
	public function get_authorization_url( $order ) {
		return add_query_arg( 'wc-stripe-connect-confirmation', 1, $order->get_checkout_payment_url( false ) );
	}
