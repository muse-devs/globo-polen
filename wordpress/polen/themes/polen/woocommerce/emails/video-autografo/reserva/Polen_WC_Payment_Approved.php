                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style='color: #ffffff; border-bottom: 0; font-weight: bold; line-height: 100%; vertical-align: middle; font-family: Poppins, "Helvetica Neue", Helvetica, Arial, sans-serif;'>
                                        <tr align="center">
                                            <td style="border-bottom: 1px solid rgba(255, 255, 255, 0.2);">
                                                <img src="<?php echo TEMPLATE_URI.'/assets/img/video-autografo/rebeldes.png'?>" style="height: 350px;text-align: center; display: block;"></img>
                                            ...
                                            <td valign="top" style="background-color: #571210;">
                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td valign="top">
                                                            <div id="body_content_inner" style='color: #ffffff; font-family: Roboto, "Helvetica Neue", Helvetica, Arial, sans-serif; font-size: 14px; line-height: 100%; text-align: left;'>
                                                                <h2 style="text-align: center; color: #fff; font-weight: 900;">Pedido de vídeo-autógrafo recebido.</h2>
                                                                <p style="font-size: 16px; line-height: 2; font-weight: 400; color: #ffffff; margin: 0 0 10px; text-align: center;">Obrigado por participar. Em breve enviaremos atualizações sobre o seu pedido.</p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr style='color: #ffffff; font-family: Poppins, "Helvetica Neue", Helvetica, Arial, sans-serif; font-size: 14px; line-height: 100%; text-align: left;'>
                                                        <td align="center">
                                                            <span style="padding: 20px 40px; background-color: #e0393e; font-size: 16px; font-weight: 900;border-radius: 8px;">Número do pedido: <?php echo $order->get_order_number(); ?></span>
                                                        </td>
                                                    </tr>
                                                    <tr align="center" style='color: #ffffff; font-family: Poppins, "Helvetica Neue", Helvetica, Arial, sans-serif; font-size: 14px; line-height: 100%; text-align: left;'>
                                                        <td align="center">
                                                            <p style="font-size: 16px; line-height: 2; font-weight: 400; color: #ffffff; margin: 0 0 10px; text-align: center;">Para acompanhar seu pedido <a href="<?php echo polen_get_link_order_status( $order->get_id() ); ?>" target="_blank" style="color: #e0393e; font-weight: 600; text-decoration: none;">clique aqui.</a></p>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- End Content -->
