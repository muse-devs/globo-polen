                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div id="body_content_inner" style='color: #ffffff; font-family: Roboto, "Helvetica Neue", Helvetica, Arial, sans-serif; font-size: 14px; line-height: 100%; text-align: left;'>
                                                                ...
                                                                <p style="font-size: 16px; line-height: 2; font-weight: 400; color: #ffffff; margin: 0 0 10px; text-align: center;">Seu pedido de <b>número <?php echo $order->get_order_number(); ?></b> foi aceito e logo você receberá seu vídeo-autógrafo personalizado.</p>
                                                            </div>
                                                        </td>
                                                    </tr>
