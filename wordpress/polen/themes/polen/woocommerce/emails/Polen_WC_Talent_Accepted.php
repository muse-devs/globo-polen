...
<p><?php printf( esc_html__( 'Olá, %1$s aceitou o seu pedido #%2$s de vídeo de e deverá responder em até 7 dias.', 'woocommerce' ), esc_html($talent['name']), esc_html($order->get_order_number()) ); ?></p>
