			...
			<div class="col-12">
				...
				<div class="row">
					<div class="col-12 d-flex">
						...
						<button type="submit" class="btn btn-outline-light btn-lg" name="apply_coupon" value="<?php esc_attr_e('Apply coupon', 'woocommerce'); ?>"><?php esc_html_e('Apply', 'woocommerce'); ?></button>
					</div>
				</div>
			</div>
		</div>
