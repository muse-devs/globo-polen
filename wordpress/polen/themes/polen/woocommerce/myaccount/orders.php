	...
	<?php else : ?>
		<div class="row">
			<div class="col-12 text-center mt-3">
				...
				<a class="woocommerce-Button btn btn-outline-light btn-lg btn-block mt-3" href="<?php echo esc_url(apply_filters('woocommerce_return_to_shop_redirect', wc_get_page_permalink('shop'))); ?>"><?php esc_html_e('Ver talentos', 'woocommerce'); ?></a>
			</div>
		</div>
	<?php endif; ?>
