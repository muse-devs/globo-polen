									...
									<div class="col-12 mt-3">
										<div class="row">
											<div class="col-12 col-md-4">
												...
												?>
													<button class="btn btn-primary btn-lg btn-block btn-enviar-video" button-nonce="<?php echo $order_nonce; ?>" order-id="<?php echo $order['order_id']; ?>" data-toggle="" data-target="" onclick="window.location.href = '/enviar-video/?order_id=<?php echo $order['order_id']; ?>'">Enviar vídeo</button>
												<?php
												}
