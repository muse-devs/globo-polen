					...
					<div class="col-md-12">
						<div class="msg msg-body">
							<div class="row">
								...
								<div class="col-12 col-md-8 py-4 my-4">
									<div class="row">
									...
									<p class="mt-4 text-center"><a class="btn btn-primary btn-lg" href="<?php echo wc_get_account_endpoint_url('orders'); ?>">Ganhar agora</a></p>
								</div>
							</div>
						</div>
					</div>
