...
add_filter( 'woocommerce_product_data_tabs', function( $array ){
	$array['charity'] = array(
		'label'    => 'Caridade',
...
function charity_product_data_product_tab_content() {
...
add_filter( 'woocommerce_product_data_panels', 'charity_product_data_product_tab_content' );
