...
function va_get_home_banner($link, $title, $subtitle, $imgdesktop, $imgmobile)
{
?>
	<div class="row mt-4">
		<div class="col-12">
			<div class="va-banner">
				<img class="image mobile-img" src="<?php echo $imgmobile ?>" alt="<?php echo $title ?>">
				<img class="image desktop-img" src="<?php echo $imgdesktop ?>" alt="<?php echo $title ?>">
				<div class="content">
