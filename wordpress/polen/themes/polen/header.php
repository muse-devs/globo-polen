...
<body <?php body_class(); ?>>
	...
	<div id="page" class="container site">
		<header id="masthead" class="row pt-3 pb-4<?php echo is_front_page() || social_is_in_social_app() ? " header-home" : ""; ?>">
			<div class="col-7 col-sm-6 d-flex align-items-center">
				<?php polen_the_theme_logos(); ?>
			</div>
			<?php if(!polen_is_landingpage()) : ?>
			<div class="col-5 col-sm-6 d-flex justify-content-end align-items-center">
				<?php //get_search_form();
				?>
				<div class="ml-2">
					<div class="dropdown">
