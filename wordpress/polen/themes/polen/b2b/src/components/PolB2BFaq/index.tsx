        ...
        <Col md={10} className='mt-5 mx-auto'>
          <Accordion className={"faq-accordion"}>
            <Accordion.Item eventKey="0">
              <Accordion.Header className="typo-xs py-4"><strong>O que são os vídeos Polen para Empresas ?</strong></Accordion.Header>
            ...
            <Accordion.Item eventKey="1">
              <Accordion.Header className="typo-xs py-4"><strong>Quanto tempo leva para receber o vídeo Polen para Empresas ?</strong></Accordion.Header>
              <Accordion.Body className="typo-xs py-3">
            ...
            <Accordion.Item eventKey="2">
              <Accordion.Header className="typo-xs py-4"><strong>Consigo um vídeo Polen para Empresas no mesmo dia ?</strong></Accordion.Header>
              <Accordion.Body className="typo-xs py-3">
            ...
            <Accordion.Item eventKey="3">
              <Accordion.Header className="typo-xs py-4"><strong>Posso usar vários vídeos Polen para Empresas para uma mesma campanha ?</strong></Accordion.Header>
              <Accordion.Body className="typo-xs py-3">
            ...
            <Accordion.Item eventKey="4">
              <Accordion.Header className="typo-xs py-4"><strong>Qual o prazo de licença para utilização do  vídeo Polen para Empresas ?</strong></Accordion.Header>
              <Accordion.Body className="typo-xs py-3">
            ...
            <Accordion.Item eventKey="5">
              <Accordion.Header className="typo-xs py-4"><strong>Em quais canais posso veicular os vídeo Polen para Empresas ? </strong></Accordion.Header>
              <Accordion.Body className="typo-xs py-3">
            ...
            <Accordion.Item eventKey="6">
              <Accordion.Header className="typo-xs py-4"><strong>O ídolo também vai postar o vídeo em seus canais?</strong></Accordion.Header>
              <Accordion.Body className="typo-xs py-3">
            ...
            <Accordion.Item eventKey="7">
              <Accordion.Header className="typo-xs py-4"><strong>Posso editar o vídeo Polen para Empresas após recebê-lo?</strong></Accordion.Header>
              <Accordion.Body className="typo-xs py-3">
            ...
            <Accordion.Item eventKey="8">
              <Accordion.Header className="typo-xs py-4"><strong>Posso remover a marca d'água Polen ou adicionar o logotipo da minha empresa ao vídeo Polen para empresas ?</strong></Accordion.Header>
              <Accordion.Body className="typo-xs py-3">
            ...
            <Accordion.Item eventKey="10">
              <Accordion.Header className="typo-xs py-4"><strong>Quanto custa pedir um vídeo Polen para Empresas ?</strong></Accordion.Header>
              <Accordion.Body className="typo-xs py-3">
