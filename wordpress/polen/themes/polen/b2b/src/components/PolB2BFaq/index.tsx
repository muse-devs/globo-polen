        ...
        <Col md={10} className='mt-5 mx-auto'>
          <Accordion className={"faq-accordion"}>
            ...
            <Accordion.Item eventKey="5">
              <Accordion.Header className="typo-md py-4"><strong>Em quais canais posso veicular os vídeo Polen para Empresas ? </strong></Accordion.Header>
              <Accordion.Body className="typo-sm py-3">
            ...
            <Accordion.Item eventKey="6">
              <Accordion.Header className="typo-md py-4"><strong>O ídolo também vai postar o vídeo em seus canais?</strong></Accordion.Header>
              <Accordion.Body className="typo-sm py-3">
            ...
            <Accordion.Item eventKey="7">
              <Accordion.Header className="typo-md py-4"><strong>Posso editar o vídeo Polen para Empresas após recebê-lo?</strong></Accordion.Header>
              <Accordion.Body className="typo-sm py-3">
            ...
            <Accordion.Item eventKey="8">
              <Accordion.Header className="typo-md py-4"><strong>Posso remover a marca d'água Polen ou adicionar o logotipo da minha empresa ao vídeo Polen para empresas ?</strong></Accordion.Header>
              <Accordion.Body className="typo-sm py-3">
                A marca d'água Polen não pode ser removida, no entanto, oferecemos marcas d'água co-branded por um custo adicional.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="9">
              <Accordion.Header className="typo-md py-4"><strong>Onde posso encontrar mais informações sobre as Políticas de Privacidade e Uso da plataforma?</strong></Accordion.Header>
              <Accordion.Body className="typo-sm py-3">
                Você pode encontrar todas essas informações no nosso Termo de Uso e na nossa Política de Privacidade.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="10">
              <Accordion.Header className="typo-md py-4"><strong>Quanto custa pedir um vídeo Polen para Empresas ?</strong></Accordion.Header>
              <Accordion.Body className="typo-sm py-3">
